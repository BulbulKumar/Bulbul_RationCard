        ...
        @csrf
            ...
            <input type="ward number" name="ward_number"placeholder="Address_ward_number" size="6"  value="7789">
              ...
              <!--<form action="/action_page.php">-->
               <textarea name="message" style="width:60px; height:40px;">remark:</textarea><br>
               Electoral ID<input type="file" id="myFile" name="Electoral_id"><br>
                    Photo <input type="file" id="myFile" name="photo"><br>
                    Education Certificate<input type="file" id="file" name="Education_Certificate"><br>
                    Work Experience<input type="file" id="file" name="Work_Experience"><br>
                    Medical Certificate<input type="file" id="myFile" name="Medical_Certificate"><br><br><br>
                <!--</form>-->
